(() => {
    ...
    da.init();
    const itemMenu = document.querySelectorAll(".menu__item")[1];
    const subMenu = document.querySelector(".submenu");
    const prevBtn = document.querySelector(".swiper-button-prev");
    const nextBtn = document.querySelector(".swiper-button-next");
    const firstSlide = document.querySelectorAll(".indicator-swiper__number")[0];
    const secondSlide = document.querySelectorAll(".indicator-swiper__number")[1];
    const half = document.querySelector(".half");
    const secondHalf = document.querySelector(".second-half");
    const script_tabs = document.querySelectorAll("[data-tabs-title]");
    const tabBodies = document.querySelectorAll("[data-tabs-body]");
    ...
    prevBtn.addEventListener("click", (() => {
        if (!firstSlide.classList.contains("current") && !half.classList.contains("current-line")) {
            firstSlide.classList.add("current");
            half.classList.add("current-line");
        }
        secondSlide.classList.remove("current");
        secondHalf.classList.remove("current-line");
    }));
    nextBtn.addEventListener("click", (() => {
        if (!secondSlide.classList.contains("current") && !secondHalf.classList.contains("current-line")) {
            secondSlide.classList.add("current");
            secondHalf.classList.add("current-line");
        }
        firstSlide.classList.remove("current");
        half.classList.remove("current-line");
    }));
    script_tabs.forEach((tab => {
        tab.addEventListener("click", (() => {
            ...
            const target = document.querySelector(tab.dataset.tabsTitle);
            ...
            if (target.id === "all") tabBodies.forEach((body => {
